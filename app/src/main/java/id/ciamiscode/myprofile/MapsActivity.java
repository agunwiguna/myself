...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker
        LatLng alamat = new LatLng(-6.882550, 107.612620);
        mMap.addMarker(new MarkerOptions().position(alamat).title("Alamat Agun Wiguna"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(alamat));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(alamat, zoomLevel));
